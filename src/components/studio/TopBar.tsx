...
export function TopBar({ onExport, exportError, onUndo, onRedo, onToggleAssistant, onPreview, onPublish }: TopBarProps) {
  ...
  return (
    <>
      <header data-testid="builder-top-bar" className="h-11 flex-shrink-0 flex items-center px-4 gap-3 bg-[#1b1b1f] border-b border-[#2a2a2e] z-20">
        ...
        >
          <svg viewBox="0 0 16 16" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M2 4h12M2 8h8M2 12h5" strokeLinecap="round"/></svg>
          Full Project Code
        </button>
